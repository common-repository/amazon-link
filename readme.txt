...
Upgrade to remove any lingering unsecure URLs. Also attempt to make links conform to the AWS standard.

**3.2.9**
Upgrade to add support for Australia locale, fix some issues with images, and media library import.

**3.2.8**
Upgrade for ability to disable some country locales, plus some minor fixes (remove some warnings)

**3.2.7**
Upgrade for minor tweeks (default template & disable of template previews)
