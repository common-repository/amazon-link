...
<img src="//www.assoc-amazon.%TLD%/e/ir?t=%TAG%&l=as2&o=%MPLACE_ID%&a=%ASIN%" width="1" height="1" border="0" alt="" style="border:none !important; margin:0px !important;" />
</div>');
...
<script type=\'text/javascript\' src=\'//wms-%REGION%.amazon-adsystem.com/20070822/%MPLACE%/js/swfobject_1_5.js\'>
</script>');

$search_template = htmlspecialchars ('
...
<iframe src="//rcm-%REGION%.amazon-adsystem.com/e/cm?lt1=_blank&bc1=000000&IS2=1&bg1=FFFFFF&fc1=000000&lc1=0000FF&t=%TAG%&o=%MPLACE_ID%&p=8&l=as4&m=amazon&f=ifr&ref=ss_til&asins=%ASIN%&MsrketPlace=%MPLACE%" style="width:120px;height:240px;" scrolling="no" marginwidth="0" marginheight="0" frameborder="0"></iframe>
');

$iframe2_template = htmlspecialchars ('
<iframe style="width:120px;height:240px;" marginwidth="0" marginheight="0" scrolling="no" frameborder="0" src="//ws-%REGION%.amazon-adsystem.com/widgets/q?region=%MPLACE%&ServiceVersion=20070822&OneJS=1&Operation=GetAdHtml&MarketPlace=%MPLACE%&source=ss&ref=ss_til&ad_type=product_link&tracking_id=%TAG%&marketplace=amazon&placement=%ASIN%&asins=%ASIN%&linkId=DGJQFSEETVP4VISP&show_border=true&link_opens_in_new_window=true">
</iframe>');
...
<script type=\'text/javascript\' src=\'//wms-%REGION%.amazon-adsystem.com/20070822/%MPLACE%/js/AmazonWidgets.js\'>
</script>');
...
<script type="text/javascript" src="//wms-%REGION%.amazon-adsystem.com/20070822/%MPLACE%/js/link-enhancer-common.js?tag=%TAG%">
</script>
<noscript>
    <img src="//wms-%REGION%.amazon-adsystem.com/20070822/%MPLACE%/img/noscript.gif?tag=%TAG%" alt="" />
</noscript>');

$easy_banner_template = htmlspecialchars ('
<iframe src="//rcm-%REGION%.amazon-adsystem.com/e/cm?t=%TAG%&o=%MPLACE_ID%&p=48&l=ur1&category=amazonhomepage&f=ifr&linkID=TUCSMEO7D7NEDG5M" width="728" height="90" scrolling="no" border="0" marginwidth="0" style="border:none;" frameborder="0"></iframe>');

$add_to_cart_template = htmlspecialchars ('
<form method="GET" action="//www.amazon.%TLD%/gp/aws/cart/add.html">
 ...
 <input type="image" name="add" value="Buy from Amazon.%TLD%" border="0" alt="Buy from Amazon.%TLD%" src="%BUY_BUTTON%">
         ...
         $this->default_templates = array (
            'add to cart' => array ( 'Name' => 'Add To Cart', 'Description' => __('Buy From Amazon Button', 'amazon-link'), 
                                 'Content' => $add_to_cart_template, 'Version' => '3', 'Notice' => 'Fix non-secure http: warnings', 'Type' => 'Product', 'Preview_Off' => 0 ),
            'banner easy' => array ( 'Name' => 'Banner Easy', 'Description' => __('Easy Banner (468x60)', 'amazon-link'), 
                                 'Content' => $easy_banner_template, 'Version' => '3', 'Notice' => 'Fix non-secure http: warnings', 'Type' => 'No ASIN', 'Preview_Off' => 0 ),
            'carousel' => array ( 'Name' => 'Carousel', 'Description' => __('Amazon Carousel Widget (limited locales)', 'amazon-link'), 
                                  'Content' => $carousel_template, 'Version' => '3', 'Notice' => 'Fix non-secure http: warnings', 'Type' => 'Multi', 'Preview_Off' => 0 ),
            'search' => array ( 'Name' => 'Search', 'Description' => __('Amazon Search Widget (limited locales)', 'amazon-link'), 
                                  'Content' => $search_template, 'Version' => '2', 'Notice' => 'Fix non-secure http: warnings', 'Type' => 'No ASIN', 'Preview_Off' => 0 ),
            'iframe image' => array ( 'Name' => 'Iframe Image', 'Description' => __('Standard Amazon Image Link', 'amazon-link'), 
                                  'Content' => $iframe_template, 'Type' => 'Product', 'Version' => '3', 'Notice' => 'Fix non-secure http: warnings', 'Preview_Off' => 0 ),
            'iframe image2' => array ( 'Name' => 'Iframe Image', 'Description' => __('Standard Amazon Image Link', 'amazon-link'),
                                  'Content' => $iframe2_template, 'Type' => 'Product', 'Version' => '2', 'Notice' => 'Fix non-secure http: warnings', 'Preview_Off' => 0 ),
            'image' => array ( 'Name' => 'Image', 'Description' => __('Localised Image Link', 'amazon-link'), 
                                  'Content' => $image_template, 'Type' => 'Product', 'Version' => '3', 'Notice' => 'Fix non-secure http: warnings', 'Preview_Off' => 0 ),
            'mp3 clips' => array ( 'Name' => 'MP3 Clips', 'Description' => __('Amazon MP3 Clips Widget (limited locales)', 'amazon-link'), 
                                  'Content' => $mp3_clips_template, 'Version' => '3', 'Notice' => 'Fix non-secure http: warnings', 'Type' => 'Multi', 'Preview_Off' => 0 ),
            'my favourites' => array ( 'Name' => 'My Favourites', 'Description' => __('Amazon My Favourites Widget (limited locales)', 'amazon-link'), 
                                  'Content' => $my_favourites_template, 'Version' => '3', 'Notice' => 'Fix non-secure http: warnings', 'Type' => 'Multi', 'Preview_Off' => 0 ),
            'preview script' => array ( 'Name' => 'Preview Script', 'Description' => __('Add Amazon Preview Pop-up script (limited locales)', 'amazon-link'),
                                  'Content' => $preview_script_template, 'Version' => '3', 'Notice' => 'Fix non-secure http: warnings', 'Type' => 'No ASIN', 'Preview_Off' => 1 ),
            'thumbnail' => array ( 'Name' => 'Thumbnail', 'Description' => __('Localised Thumb Link', 'amazon-link'), 
                                  'Content' => $thumbnail_template, 'Type' => 'Product', 'Version' => '3', 'Notice' => 'Fix non-secure http: warnings', 'Preview_Off' => 0 ),
            'wishlist' => array ( 'Name' => 'Wishlist', 'Description' => __('Used to generate the wishlist', 'amazon-link'), 
                                  'Content' => $wishlist_template, 'Type' => 'Product', 'Version' => '3', 'Notice' => 'Fix non-secure http: warnings', 'Preview_Off' => 0),
            'multinational' => array ( 'Name' => 'Multinational', 'Description' => __('Example Multinational Template', 'amazon-link'), 
                                  'Content' => $multinational_template, 'Type' => 'Product', 'Version' => '4', 'Notice' => 'Fix non-secure http: warnings', 'Preview_Off' => 0)
